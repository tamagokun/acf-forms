	...
	register_field_group(array (
		...
		'fields' => array (
			...
			array (
				...
				'label' => 'User email field name',
				'name' => 'notification_field_name',
				'type' => 'text',
                'instructions' => 'The field name used to capture the user\'s email address.',
                'default_value' => '',
				'placeholder' => '',
				'prepend' => '',
				'append' => '',
			...
			array (
				...
				'type' => 'wysiwyg',
				'instructions' => 'Email body of notification. Insert field values by using bracket enclosed field names. (i.e. [first_name] [email] [message])',
				'default_value' => '',
				'toolbar' => 'full',
				'media_upload' => 'no',
			),
			...
			array (
				...
				'type' => 'wysiwyg',
				'instructions' => 'Body of admin email notification. Insert field values by using bracket enclosed field names. (i.e. [first_name] [email] [message])',
				'default_value' => '',
				'toolbar' => 'full',
				'media_upload' => 'yes',
			),
            array (
                'key' => 'field_53716277197ac',
                'label' => '',
                'name' => 'admin_include_fields_in_email',
                'type' => 'true_false',
                'message' => 'Include a list of fields?',
                'default_value' => 0,
			),
		),
		'location' => array (
